...
public:
  ...
  void
  setUniformType(const std::string& uniform, int value);


  void 
  setUniformVec3(const std::string& uniform, const Vector3 value);

  void
  setUniformFloat(const std::string& uniform, float value);
private:
