...
void
ShaderProgram::setUniformType(const std::string& uniform, int value)
{
  GLint location = getUniformLocation (uniform);
...
void 
ShaderProgram::setUniformVec3(const std::string& uniform, Vector3 value)
{
  GLint location = getUniformLocation (uniform);
...
void
ShaderProgram::setUniformFloat(const std::string& uniform, float value)
{
  GLint location = getUniformLocation (uniform);
