/* 
  Filename: Main.cpp
  Authors: Gary M. Zoppetti, Ph.D. & Chad Hogg, John Shenk
  Course: CSCI375
...
// One VAO for the triangle, one for the point, and an additional shape created by John
...
initScene ()
{
  ...
  ////////////////////////John Shenk's VAO////////////////////////////////
  //set up four-sided shape geometry
